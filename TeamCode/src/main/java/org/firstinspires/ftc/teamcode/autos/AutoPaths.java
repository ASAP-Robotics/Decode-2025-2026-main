...
public class AutoPaths {
            ...
            new SequentialAction( // BIG BOI
                    ...
                    new SequentialAction( // pickup2 (gate pickup)
                            ...
                            drive
                                    ...
                                    .strafeToLinearHeading(
                                            new Pose2d(16 + xOffset*flipy, -62.5 * flipy, flipy * Math.toRadians(-90)).position,
                                            flipy * Math.toRadians(-90),
                                            new TranslationalVelConstraint(250.0),
                                            new ProfileAccelConstraint(-50, 240))
                                    //GATE PICKUP
                    ...
                    new SequentialAction( // pickup close
                            drive
                                    ...
                                    .splineToLinearHeading(
                                            // pickup PPG first slot
                                            new Pose2d(-16+xOffset*flipy*2, -51 * flipy, flipy * (Math.toRadians(-90))),
                                            (Math.PI / -3) * flipy,
  ...
  ParallelAction getCloseSide15Auto2GatePickupWith3GateHit(ScoringSystem scoringSystem, MecanumDrive drive, Telemetry telemetry){
    double secondShootX = -5.5;
    double secondShootY = -17;
    final int angleOffset;
    final double xOffset = -1;
                    ...
                    new SequentialAction( // pickup 1 PGP
                            ...
                            drive
                                    ...
                                    .splineToLinearHeading(
                                            ...
                                            new ProfileAccelConstraint(-30, 140))
                                    .waitSeconds(0.05)
                                    .strafeToLinearHeading(new Pose2d(12, -55 * flipy, flipy * (Math.toRadians(-90))).position,flipy * (Math.toRadians(0)))
                                    // shoot 2
                                    .strafeToLinearHeading(new Vector2d(secondShootX,secondShootY*flipy),flipy * (Math.toRadians(-90)),new TranslationalVelConstraint(250.0),
                                            new ProfileAccelConstraint(-50, 240))
                                    .build(),
