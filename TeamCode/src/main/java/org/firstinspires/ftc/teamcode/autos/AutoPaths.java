...
public class AutoPaths {
    ...
    ParallelAction getFarSideAuto(ScoringSystem scoringSystem, MecanumDrive drive, Telemetry telemetry){
                ...
                new SequentialAction( // BIG BOI
                        ...
                        new SequentialAction( // shoot 1
                                drive
                                        ...
                                        .waitSeconds(0.75)
                                        // shoot 2
                                        .strafeToLinearHeading(new Vector2d(44,-10*flipy),flipy * (Math.toRadians(-90)),
    ...
    ParallelAction getCloseSide15Auto(ScoringSystem scoringSystem, MecanumDrive drive, Telemetry telemetry){
    ...
    ParallelAction getCloseSide12Auto(ScoringSystem scoringSystem, MecanumDrive drive, Telemetry telemetry){
        double secondShootX = -5.5;
        double secondShootY = -17;
        return new ParallelAction( // BIGGEST BOI
                new updateScoring(scoringSystem, telemetry),
    ...
    ParallelAction getCloseSide15Auto2Gate(ScoringSystem scoringSystem, MecanumDrive drive, Telemetry telemetry){
        double secondShootX = -5.5;
        double secondShootY = -17;
        return new ParallelAction( // BIGGEST BOI
                new updateScoring(scoringSystem, telemetry),
