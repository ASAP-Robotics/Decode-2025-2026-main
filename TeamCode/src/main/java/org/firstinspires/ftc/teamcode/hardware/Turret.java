  ...
  protected LookupTableItem[] fillLookupTable() {
    ...
    return new LookupTableItem[] {
      ...
      // Tuned Data (Sorted Low to High)
            new LookupTableItem(33.5, 2000, 110),
            new LookupTableItem(41.0, 2100, 51),
            new LookupTableItem(49.3, 2150, 50),
            new LookupTableItem(52.9, 2300, 37),
            new LookupTableItem(55.2, 2300, 38),
            new LookupTableItem(56.7, 2350, 38),
            new LookupTableItem(63.1, 2350, 39),
            new LookupTableItem(66.4, 2400, 30),
            new LookupTableItem(70.8, 2400, 29),
            new LookupTableItem(78.3, 2500, 28),
            new LookupTableItem(81.3, 2600, 26),
            new LookupTableItem(85.6, 2600, 26),
            new LookupTableItem(93.3, 2600, 30),
            new LookupTableItem(95.4, 2600, 30),
            new LookupTableItem(96.3, 2800, 15),
            new LookupTableItem(104.1, 2800, 20),
            new LookupTableItem(106.6, 2870, 12),
            new LookupTableItem(122.2, 3000, 5),
            new LookupTableItem(138.5, 3180, 0),
