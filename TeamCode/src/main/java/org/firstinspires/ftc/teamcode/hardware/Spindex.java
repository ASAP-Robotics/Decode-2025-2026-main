...
public class Spindex {
  ...
  // TODO: tune
  private final static double lifterRetractedPos = 20; // position of lift servos when at rest
  private final static double lifterExtendedPos = 180; // position of lift servos when shooting
